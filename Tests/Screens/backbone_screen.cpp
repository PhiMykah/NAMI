...
int main(int argc, char *argv[]) {
    ...
    char output_dir[150];
    char output[200];
    const char* mat_name = "NAMI/examples/backbone.npy";
    const char* output_name = "Data/Backbone/nami_outputs";
    ...
    for (Initiator init_type : init_types)
    {
        ...
        // std::string ic_path = std::string(getenv("ONE_PIECE")) + "/" + std::string("initial_centroids.bin");
